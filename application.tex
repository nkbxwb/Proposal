...
We may then add in our treatment variable to see how they affect the hazard ratio, and see how they changes other factors. Adding chemotherapy can be seen in figure \ref{fig:acmichemo}, and for the HER2 positive patients, the HER2-directed drugs can be seen in figure \ref{fig:acmiher2}. As it has been posited before, the use of chemotherapeutic and HER2-directed drugs seem to greatly reduce the hazard ratio of death from cancer in comparison with not taking any treatment. The effect of other covariates in the presence of these drugs seems to change though.
\begin{table}[!ht]
\centering
\adjustbox{max height=\dimexpr\textheight-5.5cm\relax,
           max width=\textwidth}{
...
\end{tabular}}
\caption{Chemotherapeutic ATE with IPTW, AC and MI}
\label{tab:chemoonly}
\end{table}
...
\end{tabular}}
\caption{Chemotherapeuic ATE, doubly robust IPTW estimate, AC and MI}
\label{chemorobust}
\end{table}
...
\end{tabular}}
\caption{HER2-directed ATE with IPTW, AC and MI}
\label{tab:lapatonly}
\end{table}
...
\end{tabular}}
\caption{HER2-directed ATE, doubly robust IPTW estimate, AC and MI}
\label{lapatfull}
\end{table}
\end{center}
